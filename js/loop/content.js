...
(function (global) {
  ...
  CSL.Content = {
    ...
    claims: {
      'C-rbc-morph':      { text: '人類成熟紅血球為雙凹圓盤形，直徑約 7–8 µm。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '人類；形態學常識層級。' },
      'C-rbc-nucleus':    { text: '哺乳類成熟紅血球沒有細胞核。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '哺乳類（含人類）；鳥類等例外。' },
      'C-rbc-lifespan':   { text: '人類紅血球生命週期約 120 天，由骨髓生成。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '健康成人近似值。' },
      'C-rbc-hemo':       { text: '紅血球以血紅素攜帶氧，在肺部裝載、在組織釋出。', contentType: 'biology_reference', sourceIds: ['S1', 'S2'], reviewStatus: 'draft-pending', supportedLimit: '概念層級；不含解離曲線。' },
      'C-hemo-iron':      { text: '血紅素是含鐵蛋白，鐵部位與氧可逆結合。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '概念層級。' },
      'C-at1-thin':       { text: 'AT1 是極薄的大面積鱗狀上皮，覆蓋肺泡壁大部分表面。', contentType: 'biology_reference', sourceIds: ['S3', 'S4'], reviewStatus: 'draft-pending', supportedLimit: '人肺組織學描述。' },
      'C-at1-gas':        { text: 'AT1 的薄壁是氣體擴散交換的結構條件。', contentType: 'biology_reference', sourceIds: ['S1', 'S3'], reviewStatus: 'draft-pending', supportedLimit: '概念層級。' },
      'C-at2-shape':      { text: 'AT2 為立方形上皮，散布於肺泡壁。', contentType: 'biology_reference', sourceIds: ['S3'], reviewStatus: 'draft-pending', supportedLimit: '人肺組織學描述。' },
      'C-at2-surf':       { text: 'AT2 合成分泌表面活性物質，降低肺泡表面張力。', contentType: 'biology_reference', sourceIds: ['S3'], reviewStatus: 'draft-pending', supportedLimit: '概念層級；本模型無此變數。' },
      'C-at2-progenitor': { text: 'AT2 被認為是 AT1 受損後修補的細胞來源。', contentType: 'biology_reference', sourceIds: ['S3', 'S6'], reviewStatus: 'draft-pending', supportedLimit: '文獻共識層級；細節仍在研究中。' },
      'C-ac-barrier':     { text: '肺泡氣血屏障由 AT1 上皮、基底膜與毛細血管內皮緊貼構成，氣體以極短距離擴散。', contentType: 'biology_reference', sourceIds: ['S1', 'S3'], reviewStatus: 'draft-pending', supportedLimit: '組織學概念層級。' },
      'C-endo-interface': { text: '毛細血管內皮為單層扁平細胞，構成血液與組織間的選擇性界面。', contentType: 'biology_reference', sourceIds: ['S3', 'S5'], reviewStatus: 'draft-pending', supportedLimit: '組織學概念層級。' },
      'C-alvmac-loc':     { text: '肺泡巨噬細胞駐留在肺泡腔與小氣道。', contentType: 'biology_reference', sourceIds: ['S3'], reviewStatus: 'draft-pending', supportedLimit: '人肺。' },
      'C-alvmac-role':    { text: '肺泡巨噬細胞吞噬清除微粒、碎片與病原，是肺泡第一線防禦之一。', contentType: 'biology_reference', sourceIds: ['S3'], reviewStatus: 'draft-pending', supportedLimit: '概念層級。' },
      'C-neut-share':     { text: '嗜中性球是白血球中占比最高的類型。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '健康成人近似值。' },
      'C-neut-role':      { text: '嗜中性球沿趨化訊號招募到感染處，吞噬病原。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '概念層級。' },
      'C-tcell-family':   { text: 'T 細胞為一族：CD8 毒殺、CD4 輔助、調節性 T 細胞各有分工。', contentType: 'biology_reference', sourceIds: ['S2', 'S6'], reviewStatus: 'draft-pending', supportedLimit: '概念層級；不涉個案免疫判斷。' },
      'C-tcell-mhc':      { text: 'T 細胞以受器辨識 MHC 呈現的抗原片段後才作用。', contentType: 'biology_reference', sourceIds: ['S2'], reviewStatus: 'draft-pending', supportedLimit: '概念層級。' },
      ...
      /* 模型近似（對照本版實作核對） */
      'C-model-load':     { text: '本模型以 0–1 負載欄位近似攜帶狀態，無逐分子結合/解離。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/core.js（entity.load、交換規則）', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2；非 SpO₂。' },
      'C-model-48':       { text: '48 顆 RBC 為固定抽樣代表，數量不代表全身總量。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/core.js ENTITY_COUNT', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2。' },
      'C-model-aggregate':{ text: '肺端/組織端交換由聚合界面規則處理，沒有個別上皮/內皮細胞實體。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/model.js（edges exchange）', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2。' },
      'C-model-lungsupply': { text: 'lungSupply 參數同時作用於外部輸入項與肺端交換項，不是吸入氧濃度。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/core.js step() 輸入項與 lung 交換', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2。' },
      'C-model-flowspeed':  { text: 'flowSpeed 等比縮放各邊跨越時間，不是心率或血壓。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/model.js baseTicks', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2。' },
      'C-model-tissuedemand': { text: 'tissueDemand 同時作用於組織端交換與使用項，非單一真實生理量。', contentType: 'model_assumption', sourceIds: [], implRef: 'js/loop/core.js step() 組織交換與使用', reviewStatus: 'verified-implementation', supportedLimit: 'MODEL_VERSION 0.2.2。' },
