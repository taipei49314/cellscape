...
(function (global) {
  ...
  CSL.ContentEN = {
    ...
    shell: {
      ...
      'params.lung': 'Lung oxygen supply', 'params.flow': 'Circulation flow speed', 'params.demand': 'Tissue demand', 'params.anemia': 'Anaemia severity', 'params.temperature': 'Body temperature (°C, model)',
      ...
      'drug.fever': 'Sepsis (fever)', 'drug.baseline': 'Reset to baseline', 'drug.transfusion': 'Transfusion (improves anaemia)', 'drug.antipyretic': 'Antipyretic (reduces fever)',
